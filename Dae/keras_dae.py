...
train_data_orig = np.load('train_data_org.npy')

test_data_orig = np.load('test_data_org.npy')

train_target = np.load('train_target_org.npy')
...
train_data_noise = np.load('train_data_noise_org.npy')

test_data_noise = np.load('test_data_noise_org.npy')
...
np.save('train_data_dae_org.npy', train_data_transform)
np.save('test_data_dae_org.npy', test_data_transform)
